...
var colors = ['Verde', 'Rojo', 'Negro', 'Violeta', 'Amarillo'];
...
for (var i=0; i < colors.length; i++) {
    ...
    colors[i]=colors[i].substring(0,1).toUpperCase() + colors[i].substring(1).toLocaleLowerCase(); 
    alert (colors[i]);
}
...
//d. Crear un array vacío y con un bucle for de 10 repeticiones. Llenar el array con 
